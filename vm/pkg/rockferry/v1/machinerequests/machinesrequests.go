...
func fix(unmapped *resource.Resource[any]) *Self {
	...
	var err error
	mapped.Spec, err = convert.Convert[Spec](unmapped.RawSpec)
	if err != nil {
		panic(err)
	}
...
func (i *Interface) List(ctx context.Context, id string, owner *resource.OwnerRef) ([]*Self, error) {
	in, err := i.t.List(ctx, resource.ResourceKindMachineRequest, id, owner)
	if err != nil {
		return nil, err
	}
...
func (i *Interface) Watch(ctx context.Context, id string, owner *resource.OwnerRef) (chan *Self, error) {
	in, err := i.t.Watch(ctx, resource.ResourceKindMachineRequest, id, owner)
	if err != nil {
		return nil, err
	}
