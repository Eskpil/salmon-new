...
func (i *Interface) List(ctx context.Context, id string, owner *resource.OwnerRef) ([]*Self, error) {
	in, err := i.t.List(ctx, resource.ResourceKindStoragePool, id, owner)
	if err != nil {
		return nil, err
	}
...
func (i *Interface) Watch(ctx context.Context, id string, owner *resource.OwnerRef) (chan *Self, error) {
	in, err := i.t.Watch(ctx, resource.ResourceKindStoragePool, id, owner)
	if err != nil {
		return nil, err
	}
...
func (i *Interface) Create(ctx context.Context, resource *Self) error {
	return i.t.Create(ctx, resource.Generic())
}
